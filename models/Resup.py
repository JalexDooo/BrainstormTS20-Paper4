...
from .utils import ConvBlock, ConvUpBlock, ResConvBlock_R0, ResUpBlock
...
class ResUp(nn.Module):
    def __init__(self, in_data, out_data):
        ...
        self.up1 = ResUpBlock(kn[3], kn[2])
        self.up2 = ResUpBlock(kn[2], kn[1])
        self.up3 = ResUpBlock(kn[1], kn[0])
        self.up4 = ResUpBlock(kn[0], 16)
